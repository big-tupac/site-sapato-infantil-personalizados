...
(0, vitest_1.describe)('Completions', function () {
    ...
    (0, vitest_1.describe)('GENERATOR BLOCK', () => {
        ...
        (0, vitest_1.describe)('no generator', () => {
            (0, vitest_1.test)('with output defined', () => {
                assertCompletion({
                    schema: /* Prisma */ `
            generator gen {
            ...
            (0, vitest_1.test)('with preview features defined', () => {
                assertCompletion({
                    schema: /* Prisma */ `
            generator gen {
              previewFeatures = []
        ...
        (0, vitest_1.describe)('prisma-client', () => {
            ...
            (0, vitest_1.test)('generatedFileExtension = |', () => {
                assertCompletion({
                    schema: /* Prisma */ `
            generator gen {
              provider = "prisma-client"
            ...
            (0, vitest_1.test)('importFileExtension = |', () => {
                assertCompletion({
                    schema: /* Prisma */ `
            generator gen {
              provider = "prisma-client"
        ...
        (0, vitest_1.describe)('prisma-client-js', () => {
            (0, vitest_1.test)('Diagnoses generator field suggestions with existing fields', () => {
                assertCompletion({
                    schema: /* Prisma */ `
            generator asd {
